...
%%%%%
:- module(mat, [mat/2, mat/3, mat/4, pp_mat/1, mat_assign/2, mat_eq/2, mat_lin_comb/3,
		mat_axpy/3, mat_tr/1, mat_det/2,mat_co/2, mat_inv/2, mat_mult/2, mat_mult/3, mat_add/3, mat_sub/3,
		mat_no_cols/2, mat_no_rows/2, mat_col_arr/3, mat_row_arr/3, mat_col_list/3, mat_row_list/3]).
